...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Workout.objects.create(user=user2, workout_type='cardio', details='3km walk')
        Workout.objects.create(user=user3, workout_type='strength', details='Push-ups and squats')
